...
namespace FCloud3.WikiPreprocessor.Test
{
    ...
    {
        public static IEnumerable<object[]> GettingSlotsTestData()
        {
            yield return new object[] {"<h1>[[__名称__]]</h1><p>[[__介绍__]]</p>[[__备注__]]","名称,介绍,备注"};
            yield return new object[] {"[[__第一段__]][[__第二段__]][[__第三段__]][[__第四段_]_]!", "第一段,第二段,第三段"};
            yield return new object[] {"<[[__%错误空__]]><[[__正确空__]]>[[__ 错误空2__]]", "正确空"};
            yield return new object[] {"<[[__%正确空%__]]><[[__正确空2__]]>[[__%错%误空%__]]", "正确空,正确空2"};
            yield return new object[] {"[[__AA__]]-[[__BB__]]-[[__AA__]]-[[__CC__]]-[[__D D__]]", "AA,BB,AA,CC"};
        }

        [TestMethod]
        [DynamicData(nameof(GettingSlotsTestData))]
        ...
        public static IEnumerable<object[]> FillingTestData()
        {
        ...
        [TestMethod]
        [DynamicData(nameof(FillingTestData))]
