...
namespace FCloud3.WikiPreprocessor.Rules
{
    ...
    public static class InternalTemplates
    {
        ...
        public static List<Template> GetInstances()
        {
            ...
            //var importTest = new Template(
            //    name: "import测试",
            //    source: "<div id=\"import_test\">点击进行import测试</div>",
            //    styles: "",
            //    preScripts: "",
            //    postScripts: "import { greet } from '/greet.js';" +
            //    "console.log('init');"+
            //    "document.getElementById('import_test').addEventListener('click',()=>{greet()})"
            //    );
            return [test];
        }
    }
