...
namespace FCloud3.Diff.Test.Display
{
    ...
    public class DiffDisplayTest
    {
        ...
        {
            yield return new object[] { "01234567890", "0123abc7890", 2, "2345678~2,5", "23abc78~2,5" };
            yield return new object[] { "01234567890", "0123abcd7890", 2, "2345678~2,5", "23abcd78~2,6" };
            yield return new object[] { "01234567890", "0123ab7890", 2, "2345678~2,5", "23ab78~2,4" };
            yield return new object[] { "01234567890", "0123abc7890", 1, "34567~1,4", "3abc7~1,4" };
        }
        ...
        {
            yield return new object[] { "01234567890", "012a4567c90", 1, "234~1,2|789~1,2", "2a4~1,2|7c9~1,2" };
            yield return new object[] { "01234567890", "012a45678c0", 1, "234~1,2|890~1,2", "2a4~1,2|8c0~1,2" };
            yield return new object[] { "01234567890", "012a45678kkc0", 1, "234~1,2|890~1,2", "2a4~1,2|8kkc0~1,4" };
            yield return new object[] { "01234567890", "012a45678c0", 2, "12345~2,3|7890~2,3", "12a45~2,3|78c0~2,3" };
            yield return new object[] { "01234567890", "012a4567c90", 2, "1234567890~2,3;7,8", "12a4567c90~2,3;7,8" };
            yield return new object[] { "01234567890", "012a4567c90", 3, "01234567890~3,4;8,9", "012a4567c90~3,4;8,9" };
            yield return new object[] { "01234567890", "012a4567c90", 20, "01234567890~3,4;8,9", "012a4567c90~3,4;8,9" };
        }
        ...
        public static IEnumerable<object[]> MutipleMutistepTestData()
        {
            yield return new object[] { "01234567890", "012a4567c90", "012A4567C90", 1,
                "234~1,2|789~1,2", "2a4~1,2|7c9~1,2", "2a4~1,2|7c9~1,2", "2A4~1,2|7C9~1,2" };
            yield return new object[] { "01234567890", "012a4567c90", "012A4567C90", 2,
                "1234567890~2,3;7,8", "12a4567c90~2,3;7,8", "12a4567c90~2,3;7,8", "12A4567C90~2,3;7,8" };
            yield return new object[] { "01234567890", "012a4567c90", "012a4c90", 1,
                "234~1,2|789~1,2", "2a4~1,2|7c9~1,2", "4567c~1,4", "4c~1,1" };
            yield return new object[] { "01234567890", "012a4567c90", "012a4x67y90", 1,
                "234~1,2|789~1,2", "2a4~1,2|7c9~1,2", "4567c9~1,2;4,5", "4x67y9~1,2;4,5" };
        }

        [TestMethod]
        [DynamicData(nameof(MutipleMutistepTestData))]
